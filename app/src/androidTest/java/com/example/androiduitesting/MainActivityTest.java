...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // Verify city name is displayed (activity switch)
        onView(withId(R.id.show_city_name)).check(matches(isDisplayed()));
    }
    ...
    public void testCityName() {
        ...
        onView(withId(R.id.show_city_name)).check(matches(withText("City Name: Edmonton")));
    }
    ...
    public void testBackButton() {
        ...
        onData(anything()).inAdapterView(withId(R.id.city_list))
                .atPosition(0).perform(click());
        // Click back button
        onView(withId(R.id.show_activity_go_back)).perform(click());
        // Verify main activity is now displayed
